<script>
    ...
    //MISC PAGES
    import Error404 from './views/errorPages/404.svelte'
    import Testing from './views/Testing.svelte'
    ...
    import AceItMemory from './views/aceit/games/Memory.svelte'
    import AceItBossBattle from './views/aceit/games/boss-battle/BossBattle.svelte'
    import AceItFlashcards from './views/aceit/Flashcards.svelte'
    import AceItLearn from './views/aceit/games/Learn.svelte'
    import AceItHub from './views/aceit/Hub.svelte'
    import AceItGames from './views/aceit/Games.svelte'
    import AceItWidget from './views/aceit/widgets/Widget.svelte'
    import AceItCardWidget from './views/aceit/widgets/CardWidget.svelte'
...
<!-- MOVED TO https://apps.team1676.com/#/testing SO IT DOSENT APPEAR ON EVERY PAGE-->
        ...
        <!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="https://team1676.com/apps/connect/index.php"></iframe>
                </div>
